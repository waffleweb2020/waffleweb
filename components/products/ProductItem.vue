...
const detailsDB = ref([
  ...
  {id: 3, productId: 2, plan: 'Классический',
    items:[
  ...
  {id: 6, productId: 3, plan: 'Продвинутый',
    items:[
  ...
  {id: 9, productId: 5, plan: 'Классический',
    items:[
